...
There are a number of minor problems with this work that I would like to 
improve: no clear number of personality factors, no good way of choosing how 
many dimensions the original model should have, the parliament dimension, the 
...
\begin{enumerate}
 ...
 \item Take the loadings matrix (which will be factors x items) and perform
...
\section{Look at Samsonovich embedding}

\citep{Samsonovich2010} only found 4 dimensions. However, I think that may have been 
because they had too many semantic categories in their model. I would like to
write to them and ask for their trained vectors to see if more dimensions come out
when only a semantically coherent subset of the words are used. Because their
data is based on direct human meaning assertions (synonym and antonym 
