...
to tag words, we could not use the tagger we used for the corpus. Instead we 
used a home-grown semi-automated tagging method. The source code for the 
program used in this tagging is given in 
\ref{app:source:SemiAutomatedTagging}. 
\todo{reformat and import the source for semi-automated tagging}
