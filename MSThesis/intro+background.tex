...
FOR THE DEGREE OF \uline{Master of Science}.
...
\singlespace
Moyer, Eric David. M.S. Department of Computer Science and Engineering, 
...
\begin{figure}[tbp]
  ...
  \caption[A visualization of the dot product of two vectors $A$ and $B$.]
  {A visualization of the dot product of two vectors $A$ and $B$. The 
...
\begin{figure}[tbp]
  ...
  $B$.]{A visualization of increasing the dot product of two vectors $A$ and 
...
\begin{figure}[tbp]
  ...
  \end{subfigure}
    ...
    synthetic dataset.]{A simplified version of the \modelname{} algorithm running on a
...
\begin{figure}[tbp]
  ...
  \caption[A visualization of the two variable softmax function.]{A 
  visualization of the two variable softmax function. $x$ and $y$
...
\begin{figure}[tbp]
    ...
    \caption[Diagram showing the effect of different rotation methods.]{Diagram 
    showing the effect of different rotation methods. 
