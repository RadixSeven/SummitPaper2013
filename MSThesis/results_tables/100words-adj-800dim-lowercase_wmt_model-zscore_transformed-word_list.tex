\begin{longtable}[!htbp]{| llll |}
   ...
   warm\_jj & withdrawn\_jj    \hline
    \caption{\todo{need to caption and label the table for 100words-adj-800dim-lowercase\_wmt\_model-zscore\_transformed-word\_list.tex} } 
\end{longtable}
