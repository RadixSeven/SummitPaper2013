...
vectors. These components account for 16\% of the variance. A more complete list 
...
vectors (15\% of variance). A more complete list can be found in Appendix 
...
vectors after MDS (23\% of variance). A more complete list can be found in 
Appendix \ref{app:rankedwordlists:101words:mds}. The eigenvalues associated 
with each component are plotted in Figure 
...
vectors (11\% of variance). A more complete list can be found in Appendix 
...
word vectors (10\% of variance). A more complete list can be found in Appendix 
...
vectors after MDS (20\% of variance). A more complete list can be found in Appendix 
...
vectors (7.5\% of variance). A more complete list can be found in Appendix 
...
word vectors (7.3\% of variance). A more complete list can be found in Appendix 
...
vectors after MDS (15\% of variance). A more complete list can be found in Appendix 
